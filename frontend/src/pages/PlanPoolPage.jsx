    ...
    return (
      <div className="min-h-screen ">
          <div
            ...
            className="relative z-10 py-8 mt-20">
              <div className="mb-5 flex flex-col items-start">
                  ...
                  {!loading && items.length > 0 && (
                    <div
                      className="w-full flex flex-col md:flex-row items-start md:items-center gap-y-3 md:gap-y-0 md:gap-x-2 justify-between mb-8">
                        {/* Search Bar */}
                                  ...
                                  {currentItems.map((loc, index) => (
                                    ...
                                    >
                                        <div className="group relative">
                                            <div
                                              className="relative bg-white/80 backdrop-blur-sm rounded-2xl border border-heart-of-ice/50 ">
                                                <PlanPoolCard
                                                  name={loc.name}
                                                  city={loc.city}
