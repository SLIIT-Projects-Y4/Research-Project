            ...
            <div className="relative">
                <Autocomplete
                    ...
                    styles={{
                        ...
                        dropdown: {
                            border: '2px solid var(--color-heart-of-ice)',
                            boxShadow: '0 10px 25px rgba(0, 28, 51, 0.1)',
                        }
                    }}
                />
            </div>
            ...
            <Container size="xl" py={rem(80)}>
                ...
                <div className="text-center mb-12">
                    ...
                    <Text
                        ...
                        style={{color: 'var(--color-welded-iron)'}}
                    >
                        Design your ideal journey with our intelligent route planner
                    </Text>
                </div>
                            ...
                            <Stack gap="xl">
                                ...
                                <div>
                                    <Group mb="lg">
                                        ...
                                        >
                                            <IconNavigation size={24} style={{color: 'var(--color-brave-orange)'}}/>
                                        </Paper>
                                        <div>
                                            <Title order={3} className="font-display" style={{color: 'var(--color-midnight-dreams)'}}>
                                                Journey Points
                                    ...
                                    <Stack gap="lg">
                                        <CityAutocomplete
                                            ...
                                            placeholder={
                                                useCurrent
                                                    ? (resolvedCity ? 'Resolved from location' : 'Auto (nearest city)')
                                ...
                                <div>
                                    <Group mb="lg">
                                        ...
                                        >
                                            <IconMapPin size={24} style={{color: 'var(--color-lemon-dream)'}}/>
                                        </Paper>
                                        <div>
                                            <Title order={3} className="font-display" style={{color: 'var(--color-midnight-dreams)'}}>
                                                Saved Places
                                                                ...
                                                                {pool.map((p) => (
                                                                    ...
                                                                    >
                                                                        <Checkbox
                                                                            ...
                                                                            label={
                                                                                <div>
                                                                                    <Text fw={600} className="font-display" mb={4}>
                                                                                        {p.name}
                                                                                    </Text>
                                                                                    <Group gap="xs">
                                                                                        <IconMapPin size={14}/>
